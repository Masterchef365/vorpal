#[no_mangle]
pub extern "C" fn add(lhs: f32, rhs: f32) -> f32 {
    lhs + rhs
}

#[no_mangle]
pub extern "C" fn subtract(lhs: f32, rhs: f32) -> f32 {
    lhs - rhs
}

#[no_mangle]
pub extern "C" fn multiply(lhs: f32, rhs: f32) -> f32 {
    lhs * rhs
}

#[no_mangle]
pub extern "C" fn divide(lhs: f32, rhs: f32) -> f32 {
    lhs / rhs
}
...
#[no_mangle]
pub extern "C" fn ceil(value: f32) -> f32 {
    value.ceil()
}

#[no_mangle]
pub extern "C" fn floor(value: f32) -> f32 {
    value.floor()
}

#[no_mangle]
pub extern "C" fn abs(value: f32) -> f32 {
    value.abs()
}
